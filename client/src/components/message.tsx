          ...
          <div className="space-y-2">
            {response.follow_up_questions.map((item, index) => (
              <Button
                key={index}
                variant="ghost"
                className="block w-full text-left p-3 bg-warm-cream-100/50 border border-imperial-gold-200/50 rounded-lg hover:bg-warm-cream-200 transition-all duration-200 suggestion-card h-auto"
